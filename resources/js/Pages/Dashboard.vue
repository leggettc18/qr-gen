    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 prose">
                ...
                >
                    <div
                        class="p-6 bg-white dark:bg-gray-800 dark:text-gray-100 border-b border-gray-200 dark:border-gray-800 flex space-x-5"
                    >
                        <div v-for="link in user.links" class="flex flex-col items-center dark:bg-gray-700 rounded p-4">
                            <h2 class="dark:text-gray-200 m-1">{{ link.name }}</h2>
                            <VueQrious
                                v-if="link.url"
                                :value="link.url"
                                class="border-4 border-gray-600 rounded m-0"
                            />
                        </div>
                    </div>
                </div>
